(function (global, factory) {
    ...
    * found in the LICENSE file at https://angular.io/license
    ...
    BaseLoginProvider = /** @class */ (function () {
         ...
         * @return {?}
         */
        function (id, src, onload, async$$1, inner_text_content) {
    ...
    var GoogleLoginProvider = /** @class */ (function (_super) {
        ...
        function (opt) {
            ...
            return new Promise(function (resolve, reject) {
                _this.onReady().then(function () {
                    var /** @type {?} */ offlineAccess = (opt && opt.offline_access) || (_this.opt && _this.opt.offline_access);
                    var /** @type {?} */ promise = !offlineAccess ? _this.auth2.signIn(opt) : _this.auth2.grantOfflineAccess(opt);
